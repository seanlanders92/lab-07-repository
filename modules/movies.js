...
function handleMovies (request, response) {
    const cityObj = request.query;
    const url = `https://api.themoviedb.org/3/search/movie?api_key=${process.env.MOVIE_API_KEY}&language=en-US&query=${cityObj.search_query}&page=1&include_adult=true`  
